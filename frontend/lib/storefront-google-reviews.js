...
export const isValidStorefrontGoogleReviewsUrl = (value) =>
  validateStorefrontGoogleReviewsUrl(value).isValid;

export const hasActiveStorefrontGoogleReviews = (storefront) =>
  Boolean(storefront?.reviews_enabled) && isValidStorefrontGoogleReviewsUrl(storefront?.reviews_url);
