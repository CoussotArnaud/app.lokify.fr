...
const createMemoryPool = async () => {
  ...
  await memoryPool.query(`
    ...
    CREATE TABLE customer_payment_settings (
      ...
      customer_stripe_details_submitted BOOLEAN NOT NULL DEFAULT FALSE,
      customer_stripe_charges_enabled BOOLEAN NOT NULL DEFAULT FALSE,
      customer_stripe_payouts_enabled BOOLEAN NOT NULL DEFAULT FALSE,
      customer_stripe_requirements_due_json TEXT NOT NULL DEFAULT '[]',
      customer_stripe_disabled_reason TEXT,
      customer_stripe_display_name TEXT,
      customer_stripe_country TEXT,
      customer_stripe_last_sync_at TIMESTAMPTZ,
  ...
  await memoryPool.query(
    `
      INSERT INTO customer_payment_settings (
        ...
        customer_stripe_details_submitted,
        customer_stripe_charges_enabled,
        customer_stripe_payouts_enabled,
        customer_stripe_requirements_due_json,
        customer_stripe_display_name,
        customer_stripe_country,
        customer_stripe_last_sync_at,
