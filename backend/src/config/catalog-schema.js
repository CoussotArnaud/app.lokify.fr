export const ensureCatalogSchema = async (pool) => {
  const statements = [
    ...
    "ALTER TABLE catalog_categories ADD COLUMN IF NOT EXISTS image_alt_text TEXT",
    "ALTER TABLE catalog_categories ADD COLUMN IF NOT EXISTS banner_image_url TEXT",
    "ALTER TABLE catalog_categories ADD COLUMN IF NOT EXISTS logo_image_url TEXT",
    "ALTER TABLE catalog_categories ADD COLUMN IF NOT EXISTS meta_title TEXT",
    "ALTER TABLE catalog_categories ADD COLUMN IF NOT EXISTS meta_description TEXT",
    "ALTER TABLE catalog_categories ADD COLUMN IF NOT EXISTS images_json TEXT NOT NULL DEFAULT '[]'",
