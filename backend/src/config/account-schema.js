export const ensureAccountSchema = async (pool) => {
  const statements = [
    ...
    "ALTER TABLE customer_payment_settings ADD COLUMN IF NOT EXISTS customer_stripe_details_submitted BOOLEAN NOT NULL DEFAULT FALSE",
    "ALTER TABLE customer_payment_settings ADD COLUMN IF NOT EXISTS customer_stripe_charges_enabled BOOLEAN NOT NULL DEFAULT FALSE",
    "ALTER TABLE customer_payment_settings ADD COLUMN IF NOT EXISTS customer_stripe_payouts_enabled BOOLEAN NOT NULL DEFAULT FALSE",
    "ALTER TABLE customer_payment_settings ADD COLUMN IF NOT EXISTS customer_stripe_requirements_due_json TEXT NOT NULL DEFAULT '[]'",
    "ALTER TABLE customer_payment_settings ADD COLUMN IF NOT EXISTS customer_stripe_disabled_reason TEXT",
    "ALTER TABLE customer_payment_settings ADD COLUMN IF NOT EXISTS customer_stripe_display_name TEXT",
    "ALTER TABLE customer_payment_settings ADD COLUMN IF NOT EXISTS customer_stripe_country TEXT",
    "ALTER TABLE customer_payment_settings ADD COLUMN IF NOT EXISTS customer_stripe_last_sync_at TIMESTAMPTZ",
